            ...
            <ScrollView style={{flex: 1}}>
                ...
                <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <TouchableOpacity style={{ marginTop: 20 }} onPress={this._startDetection}>
                        <Button onPress={this._startDetection} style={{color:'blue'}} title="Start scannen"></Button>
                    </TouchableOpacity>

                    <TouchableOpacity style={{ marginTop: 20 }}>
                        <Button  onPress={this._stopDetection} color="#B22222" title="Stop scannen"></Button>
                    </TouchableOpacity>

                    <TouchableOpacity style={{ marginTop: 20 }} >
                        <Button onPress={this._clearMessages} color="#FFFF66" title="Clear"></Button>
                    </TouchableOpacity>

                    <TouchableOpacity style={{ marginTop: 20 }} onPress={this._goToNfcSetting}>
                        <Text >NFC Opties</Text>
                    </TouchableOpacity>
